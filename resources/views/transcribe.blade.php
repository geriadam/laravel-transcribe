    ...
    <div class="max-w-7xl mx-auto p-4 my-24 ">
        <div class="mx-auto max-w-2xl md:text-center bg-white rounded-xl shadow sm:p-7 dark:bg-slate-900">
            ...
            <p class="mt-4 text-lg tracking-tight text-slate-700">
                Share Your Voice with Us! Submit Your Audio Recording Today.
            </p>
                ...
                <div class="text-left">
                    ...
                    <div class="mt-2">
                        <textarea
                            ...
                            placeholder="Please describe the content or purpose of your audio recording here"
                        ></textarea>
                    </div>
                    <p class="mt-2 text-sm text-gray-500">The "Prompt" field serves as an optional opportunity for participants to add context or express their thoughts about the submitted audio. It could be a brief description of the content, an explanation of the inspiration behind the recording, or an anecdote related to the audio file.</p>
                </div>
                    ...
                    <div class="text-left">
                        <div class="relative flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p id="comments-description" class="text-sm text-gray-500">Stay informed about all the things</p>
                            </div>
                        </div>
                    </div>
                @endif
